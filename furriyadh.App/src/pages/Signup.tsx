...
const Signup = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('إنشاء حساب باستخدام:', formData);
  };
            ...
            >
              ...
              <form onSubmit={handleSubmit}>
                <motion.div className="mb-4" variants={itemVariants}>
                  <label htmlFor="fullName" className="block text-blue-200 mb-2">
                    {t('signup.fullName')}
                  </label>
                  <input 
                    type="text" 
                ...
                <motion.div className="flex items-center mb-6" variants={itemVariants}>
                  <input 
                    ...
                    required
                  />
                  <label htmlFor="agreeTerms" className="ml-2 rtl:mr-2 rtl:ml-0 text-blue-200">
                    {t('signup.agreeTerms')} 
                    <a href="/terms" className="text-blue-400 hover:text-blue-300 transition-colors ml-1 rtl:mr-1 rtl:ml-0">
                      {t('signup.termsLink')}
                    </a>
                  </label>
                </motion.div>
              ...
              <motion.div className="mt-8 text-center" variants={itemVariants}>
                <p className="text-blue-200">
                  ...
                  <a href="/login" className="text-blue-400 hover:text-blue-300 transition-colors ml-1 rtl:mr-1 rtl:ml-0">
                    {t('signup.loginLink')}
                  </a>
                </p>
              </motion.div>
